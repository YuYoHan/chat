...
public class JwtProvider {
    ...
    public JwtProvider(
        ...
        byte[] secretByteKey = Base64.getDecoder().decode(secret_key);
    ...
    public TokenDTO createToken(Authentication authentication,
        ...
        // AccessToken 생성
        // 토큰의 만료시간
        Date accessTokenExpire = new Date(now + this.accessTokenTime * 1000);
        ...
        // RefreshToken 생성
        Date refreshTokenExpire = new Date(now + this.refreshTokenTime * 1000);
